        ...
        items: [
          // USER
          {
            ...
            // children: [
              ...
              // { title: t('list of clinics'), path: paths.dashboard.user.list },
              // { title: t('list of clinics'), path: paths.dashboard.user.list },
              // { title: t('create a new clinic'), path: paths.dashboard.user.new },
              // { title: t('edit clinic'), path: paths.dashboard.user.demo.edit },
              // { title: t('clinic details'), path: paths.dashboard.user.account },
            // ],
          },
          ...
          // PRODUCT
          {
            ...
            path: paths.corporations.root,
            icon: ICONS.product,
            // children: [
            //   { title: t('list of corps'), path: paths.dashboard.product.root },
            //   {
            //     title: t('corps details'),
          ...
          // PMS
          {
            ...
            icon: ICONS.order,
            // children: [
            //   { title: t('list of pms'), path: paths.dashboard.order.root },
            //   { title: t('pms details'), path: paths.dashboard.order.demo.details },
            // ],
          },
