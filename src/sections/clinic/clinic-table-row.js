...
//
import ClinicQuickEditForm from './clinic-quick-create-form';

// ----------------------------------------------------------------------

export default function ClinicTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, onPmsreportRow }){
  ...
  return (
     <>
      ...
      {/* <ClinicQuickEditForm currentClinic={row} open={quickEdit.value} onClose={quickEdit.onFalse} /> */}
