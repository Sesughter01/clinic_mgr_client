...
export default function Adjustment({ id, allAdjustments }) {
  ...
  const columns = [
    ...
    { field: 'chrg_adj_incl', headerName: 'chrg_adj_incl', width: 100, editable: true, },
    { field: 'pmt_adj_incl', headerName: 'pmt_adj_incl', width: 100, editable: true, },
    { field: 'prov_comp_incl', headerName: 'prov_comp_incl', width: 100, editable: true, },
    { field: 'idlgr_entry_map', headerName: 'idlgr_entry_map', width: 70, editable: true, },
    { field: 'hyg_comp_incl', headerName: 'hyg_comp_incl', width: 70, editable: true, },
    { field: 'posting_Type', headerName: 'posting_Type', width: 70, editable: true, },
    { field: 'impact', headerName: 'impact', width: 40, editable: true, },
